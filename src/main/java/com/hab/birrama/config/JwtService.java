...
public class JwtService {
    ...
    */
    ...
    private static final String SECRET_KEY = "tAIHpZ8RQr9c0TNSLuZGzWJbDeUBW8Pv9mlUfbzUVJJDBypEnfL3PqTGoeHzPBrH";
    ...
    public String generateToken(UserDetails userDetails){   //generate token only form userDetails
